...
enum {
	...
	AID_EAT_ALL_ARTIFICIAL_MEAT = 49,
	AID_SURVIVE_GOD_DISINTEGRATION = 50,
	AID_PUNISHMENT = 51,
	AID_TERRIBLE_AC = 52,
	AID_AWESOME_AC = 53,
	AID_INTRINSICS_RESISTANCE = 54,
	AID_INTRINSICS_NINJA = 55,
