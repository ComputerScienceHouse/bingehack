...
E boolean FDECL(freeinv, (struct obj *));
...
E boolean FDECL(otype_on, (int,struct obj *));
E boolean FDECL(in_possession, (int));
...
E boolean FDECL(extract_nobj, (struct obj *, struct obj **));
