...
%.pg
Vegan, vegetarian, and unchallenged characters are further permitted
to eat plant products such as fruits and vegetables.
The corpses and tins of blobs (`b'), jellies (`j'), fungi (`F'), and
puddings (`P') other than the black puddings
...
diet avoids products derived from animals.  This includes eggs and
food made from eggs (fortune cookies and pancakes), food made with
milk (cream pies), and lumps of royal jelly.
...
found in the dungeon.  Eating monster brains while polymorphed
