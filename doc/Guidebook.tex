...
The primary source of nutrition are fruits and vegetables.  The
corpses and tins of blobs (`b'), jellies (`j'), fungi (`F'), and
black puddings are also considered to be vegetable matter.  Certain human
...
%.pg
Vegetarians do not eat the flesh of animals that we normally call ``meat'';
...
of pudding (`P'), eggs and food made from eggs (fortune cookies and
pancakes), food made with milk (cream pies and candy bars), and lumps of
royal jelly.  Eating leather, dragon hide, wax, or bone items while
polymorphed into a creature that can digest it, or eating monster brains
while polymorphed into a (master) mind flayer, is considered vegetarian but
nonvegan conduct.  Monks are expected to observe a vegetarian diet.
...
\begin{tabular}{lll}
%TABLE_START
Adam Aronow & Izchak Miller & Mike Gallop\\
Andy Church & Janet Walz & Mike Passaretti\\
Andy Swanson & Janne Salmij\"{a}rvi & Mike Stephenson\\
