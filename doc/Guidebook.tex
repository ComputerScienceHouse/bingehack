...
set your character class by appending a dash and one or more letters of
...
%.pg
While it is not difficult for experienced users to edit the {\it NetHack.cnf\}
...
{\it NHAccess.cnf\}.  Replacing {\it NetHack.cnf\} with this file will cause
...
are included in the {\it NetHack.cnf\} file itself. The most crucial settings to
...
Make certain that all character graphics sets found near the bottom of the
\fBNetHack.cnf\fP file are commented out.
\elist
