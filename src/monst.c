 ...
 * nymphs
 */
	/* Their AD_SEDU attacks are turned into AD_SITM ones to make them behave normally,
	 * now that these are different. The whole thing was strange anyway.
	 */
    MON("wood nymph", S_NYMPH,
	LVL(3, 12, 9, 20, 0), (G_GENO|2),
	A(ATTK(AT_CLAW, AD_SITM, 0, 0), ATTK(AT_CLAW, AD_SITM, 0, 0),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
 ...
 */
	...
	M1_HUMANOID|M1_OMNIVORE,
	M2_NOPOLY|M2_HUMAN|M2_PEACEFUL|M2_MALE, M3_INFRAVISIBLE, HI_ZAP),
...
#undef SEDUCTION_ATTACKS
	...
	M3_WANTSALL|M3_WAITFORU|M3_INFRAVISIBLE|M3_INFRAVISION, HI_LORD),
    MON("Lolth", S_DEMON,
	...
	M3_WANTSAMUL|M3_WAITFORU|M3_INFRAVISIBLE|M3_INFRAVISION, HI_LORD),
#ifdef SEDUCE
# define LILITH_ATTACKS \
	A(ATTK(AT_BITE, AD_SSEX, 0, 10), ATTK(AT_CLAW, AD_PHYS, 4, 4), \
	  ATTK(AT_MAGC, AD_FIRE, 6,  6), NO_ATTK, NO_ATTK, NO_ATTK)
#else
# define LILITH_ATTACKS \
	A(ATTK(AT_CLAW, AD_PHYS, 4,  4), ATTK(AT_MAGC, AD_FIRE, 6, 6), \
	  ATTK(AT_BITE, AD_DRLI, 2, 10), NO_ATTK, NO_ATTK, NO_ATTK)
#endif
    MON("Lilith", S_DEMON,
...
#ifdef SEDUCE
# define SAMMAEL_ATTACKS \
	A(ATTK(AT_BITE, AD_SSEX, 0, 10), ATTK(AT_CLAW, AD_PHYS, 4, 4), \
	  ATTK(AT_MAGC, AD_MAGM, 6,  6), NO_ATTK, NO_ATTK, NO_ATTK)
#else
# define SAMMAEL_ATTACKS \
	A(ATTK(AT_CLAW, AD_PHYS, 4,  4), ATTK(AT_MAGC, AD_MAGM, 6, 6), \
	  ATTK(AT_BITE, AD_DRLI, 2, 10), NO_ATTK, NO_ATTK, NO_ATTK)
#endif
    MON("Sammael", S_DEMON,
	LVL(105, 12, -7, 90, -20), (G_HELL|G_NOCORPSE|G_NOGEN|G_UNIQ),
...
#undef SAMMAEL_ATTACKS
	...
	M2_NOPOLY|M2_DEMON|M2_STALK|M2_HOSTILE|M2_PNAME|M2_NASTY|M2_STRONG|
	  M2_PRINCE|M2_NEUTER,
	M3_WAITFORU|M3_WANTSAMUL|M3_INFRAVISION, HI_LORD),
	...
	A(ATTK(AT_TUCH, AD_FAMN, 8, 8), ATTK(AT_TUCH, AD_FAMN, 8, 8),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ((WT_SKHUMAN), 1, 0, MS_RIDER, MZ_HUMAN),
	MR_FIRE|MR_COLD|MR_ELEC|MR_SLEEP|MR_POISON|MR_STONE, 0,
	M1_FLY|M1_HUMANOID|M1_REGEN|M1_SEE_INVIS|M1_TPORT_CNTRL,
	M2_NOPOLY|M2_STALK|M2_HOSTILE|M2_PNAME|M2_STRONG|M2_NASTY,
	M3_INFRAVISIBLE|M3_INFRAVISION, HI_LORD),
	/* Vices -- the Seven Deadly Sins
	 *  Do not reorder, as selection code relies on Gluttony being first.
	 */
    MON("Gluttony", S_DEMON,
	LVL(30, 12, -5, 100, 0), (G_UNIQ|G_NOGEN),
	A(ATTK(AT_ENGL, AD_DGST, 8, 8), ATTK(AT_ENGL, AD_DGST, 8, 8),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ(WT_FTHUMAN, 1, 0, MS_VICE, MZ_HUMAN),
	MR_FIRE|MR_COLD|MR_ELEC|MR_SLEEP|MR_POISON|MR_STONE, 0,
	M1_FLY|M1_HUMANOID|M1_REGEN|M1_SEE_INVIS|M1_TPORT_CNTRL|M1_OMNIVORE|M1_METALLIVORE,
	M2_NOPOLY|M2_STALK|M2_HOSTILE|M2_PNAME|M2_STRONG|M2_NASTY,
	M3_INFRAVISIBLE|M3_INFRAVISION, HI_LORD),
#ifdef SEDUCE
#  define AD_LUST AD_SSEX
#  define AD_GRED AD_SEDU
#else
#  define AD_LUST AD_SEDU
#  define AD_GRED AD_SGLD
#endif
    MON("Lust", S_DEMON,
	LVL(30, 12, -5, 100, 0), (G_UNIQ|G_NOGEN),
	A(ATTK(AT_CLAW, AD_LUST, 8, 8), ATTK(AT_CLAW, AD_LUST, 8, 8),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ(WT_HUMAN, 1, 0, MS_VICE, MZ_HUMAN),
	MR_FIRE|MR_COLD|MR_ELEC|MR_SLEEP|MR_POISON|MR_STONE, 0,
	M1_FLY|M1_HUMANOID|M1_REGEN|M1_SEE_INVIS|M1_TPORT_CNTRL,
	M2_NOPOLY|M2_STALK|M2_HOSTILE|M2_PNAME|M2_STRONG|M2_NASTY,
	M3_INFRAVISIBLE|M3_INFRAVISION, HI_LORD),
    MON("Greed", S_DEMON,
	LVL(30, 12, -5, 100, 0), (G_UNIQ|G_NOGEN),
	A(ATTK(AT_CLAW, AD_GRED, 8, 8), ATTK(AT_CLAW, AD_GRED, 8, 8),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ(WT_HUMAN, 1, 0, MS_VICE, MZ_HUMAN),
	MR_FIRE|MR_COLD|MR_ELEC|MR_SLEEP|MR_POISON|MR_STONE, 0,
	M1_FLY|M1_HUMANOID|M1_REGEN|M1_SEE_INVIS|M1_TPORT_CNTRL,
	M2_NOPOLY|M2_STALK|M2_HOSTILE|M2_PNAME|M2_STRONG|M2_NASTY,
	M3_COVETOUS|M3_INFRAVISIBLE|M3_INFRAVISION, HI_LORD),
#undef AD_LUST
#undef AD_GRED
    MON("Envy", S_DEMON,
	LVL(30, 12, -5, 100, 0), (G_UNIQ|G_NOGEN),
	A(ATTK(AT_CLAW, AD_CURS, 8, 8), ATTK(AT_CLAW, AD_CURS, 8, 8),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ(WT_HUMAN, 1, 0, MS_VICE, MZ_HUMAN),
	MR_FIRE|MR_COLD|MR_ELEC|MR_SLEEP|MR_POISON|MR_STONE, 0,
	M1_FLY|M1_HUMANOID|M1_REGEN|M1_SEE_INVIS|M1_TPORT_CNTRL,
    ...
    MON("Wrath", S_DEMON,
	LVL(30, 12, -5, 100, 0), (G_UNIQ|G_NOGEN),
	A(ATTK(AT_CLAW, AD_PHYS, 8, 8), ATTK(AT_CLAW, AD_PHYS, 8, 8),
	  ATTK(AT_CLAW, AD_DRE2, 8, 8), ATTK(AT_CLAW, AD_DRLI, 8, 8),
	  NO_ATTK, NO_ATTK),
	SIZ(WT_HUMAN, 1, 0, MS_VICE, MZ_HUMAN),
	MR_FIRE|MR_COLD|MR_ELEC|MR_SLEEP|MR_POISON|MR_STONE, 0,
	M1_FLY|M1_HUMANOID|M1_REGEN|M1_SEE_INVIS|M1_TPORT_CNTRL,
	M2_NOPOLY|M2_STALK|M2_HOSTILE|M2_PNAME|M2_STRONG|M2_NASTY,
	M3_INFRAVISIBLE|M3_INFRAVISION, HI_LORD),
    MON("Sloth", S_DEMON, /* Sloth only touches, he doesn't directly cause damage. 'Cause he's too lazy. */
	LVL(30, 12, -5, 100, 0), (G_UNIQ|G_NOGEN),
	A(ATTK(AT_TUCH, AD_LAZY, 0, 0), ATTK(AT_TUCH, AD_LAZY, 0, 0),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ(WT_HUMAN, 1, 0, MS_VICE, MZ_HUMAN),
	MR_FIRE|MR_COLD|MR_ELEC|MR_SLEEP|MR_POISON|MR_STONE, 0,
	M1_FLY|M1_HUMANOID|M1_REGEN|M1_SEE_INVIS|M1_TPORT_CNTRL,
    ...
    MON("Pride", S_DEMON,
	LVL(30, 12, -5, 100, 0), (G_UNIQ|G_NOGEN),
	A(ATTK(AT_CLAW, AD_DRCH, 8, 8), ATTK(AT_CLAW, AD_DFOO, 8, 8),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ(WT_HUMAN, 1, 0, MS_VICE, MZ_HUMAN),
	MR_FIRE|MR_COLD|MR_ELEC|MR_SLEEP|MR_POISON|MR_STONE, 0,
	M1_FLY|M1_HUMANOID|M1_REGEN|M1_SEE_INVIS|M1_TPORT_CNTRL,
