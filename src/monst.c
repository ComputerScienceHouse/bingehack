 ...
 */
	...
	LVL(5, 12, 4, 20, -5), (G_NOHELL|G_GENO|G_SGROUP|2),
 ...
 */
    MON("gas spore", S_EYE,
	LVL(1, 3, 10, 0, 0), (G_NOHELL|G_NOCORPSE|G_GENO|1),
 ...
 */
    ...
    MON("pony", S_UNICORN,
	LVL(3, 16, 6, 0, 0), (G_NOHELL|G_GENO|2),
	...
	M3_INFRAVISIBLE, CLR_BROWN),
    MON("horse", S_UNICORN,
	LVL(5, 20, 5, 0, 0), (G_NOHELL|G_GENO|2),
	...
	LVL(7, 24, 4, 0, 0), (G_NOHELL|G_GENO|2),
 ...
 */
	...
	A(ATTK(AT_WEAP, AD_PHYS, 1, 4), ATTK(AT_CLAW, AD_PHYS, 1, 4),
	  ...
	  NO_ATTK, NO_ATTK),
	SIZ(WT_HUMAN, 400, PL_NSIZ, MS_SILENT, MZ_HUMAN), MR_FIRE|MR_POISON, 0,
